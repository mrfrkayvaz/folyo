...
SYSTEM_PROMPT = (
    ...
    "   You MAY join citations from the same document with ';' into a single bracket\n"
    "   (e.g. [Doc.pdf, sayfa 1, parça 3; sayfa 2, parça 8]); keep every referenced\n"
    "   page/chunk pair accurate.\n"
